...
export const Api = (query) => {
  return (`https://www.omdbapi.com/?s=${query}&apikey=ab229482`);
}
  ...
  return (
    <div className="App">
      ...
      <div className="MovieContainer">
        ...
        <>
            <p> Please enter more than <b>3 characters</b> in search query </p>
        </>
        :
        <>
            <p> Cannot find the movie '<b>{SearchQuery}</b>' </p>
        </>
        }
      </div>
    </div>
